...
export const MaxValueFallback: Story = {
  name: "maxValue <= 0 (safeMax=1)",
  args: {
    value: 1,
    maxValue: 0,
    valueLabel: "1개",
...
export const CustomHeightRange: Story = {
...
export const InvertedHeightRange: Story = {
  name: "Inverted height range (range=0)",
  args: {
    value: 7,
    maxValue: 10,
    valueLabel: "7개",
